...
#define tBattleTypeEffectiveness data[4]
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tBattleTypeEffectiveness = gSaveBlock2Ptr->optionsBattleTypeEffectiveness;
        ...
        TypeEffect_DrawChoices(gTasks[taskId].tBattleTypeEffectiveness);
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_TYPEEFFECT:
            previousOption = gTasks[taskId].tBattleTypeEffectiveness;
            gTasks[taskId].tBattleTypeEffectiveness = TypeEffect_ProcessInput(gTasks[taskId].tBattleTypeEffectiveness);

            if (previousOption != gTasks[taskId].tBattleTypeEffectiveness)
                TypeEffect_DrawChoices(gTasks[taskId].tBattleTypeEffectiveness);
            break;
        case MENUITEM_SOUND:
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsBattleTypeEffectiveness = gTasks[taskId].tBattleTypeEffectiveness;
